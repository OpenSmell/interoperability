...
def run():
    ...
    lines.append("  - ScentFormer accuracy from Feng et al. (2025), 'ScentFormer: A Transformer")
    lines.append("    for Olfactory Sensing', measured on the same SmellNet dataset.")
